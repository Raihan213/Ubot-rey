...
async def _(c, m):
    ...
    try:
        if m.command[1] == "gc":
            ...
            await Haku.edit(f"""{brs} **ʙᴇʀʜᴀsɪʟ ᴍᴇɴᴊᴀʟᴀɴᴋᴀɴ ʙʀᴏᴀᴅᴄᴀsᴛ ᴋᴇ sᴇʟᴜʀᴜʜ ɢʀᴜᴘ**
<blockquote>{cnt}**ʙᴇʀʜᴀsɪʟ** : {done} **ɢʀᴜᴘ**</blockquote>
<blockquote>{ex}**ɢᴀɢᴀʟ** : {gagal} **ɢʀᴜᴘ**</blockquote>
**ᴘᴏᴡᴇʀᴇᴅ ʙʏ : **<a href=tg://user?id={c.me.id}>{c.me.first_name} {c.me.last_name or ''}</a>""")
            ...
            await Haku.edit(
                ...
                f"<emoji id =5465277190453085073>🤖</emoji> **powered by ʀᴇʏ-ᴜsᴇʀʙᴏᴛ** <emoji id =5895583431194054511>🌟</emoji>\n")
