...
<b>『 ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ ᴛᴀɢᴀʟʟ 』</b>
  ...
  <b>• ᴘᴇʀɪɴᴛᴀʜ:</b> <code>all</code> [ᴘᴇsᴀɴ - ʀᴇᴘ_ᴘᴇsᴀɴ]
  <b>• ᴘᴇɴᴊᴇʟᴀsᴀɴ:</b> ᴜɴᴛᴜᴋ ᴛᴀɢᴀʟʟ ᴋᴇsᴇᴍᴜᴀ ᴍᴇᴍʙᴇʀ ɢʀᴜᴘ

  <b>• ᴘᴇʀɪɴᴛᴀʜ:</b> <code>batal</code>
  <b>• ᴘᴇɴᴊᴇʟᴀsᴀɴ:</b> ᴜɴᴛᴜᴋ ᴍᴇɴɢʜᴇɴᴛɪᴋᴀɴ ᴛᴀɢᴀʟʟ
"""
