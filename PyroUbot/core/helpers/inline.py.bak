    ...
    def start(message):
        if message.from_user.id not in USER_ID:
            button = [
                ...
                [
                    InlineKeyboardButton(text="👤 ᴏᴡɴᴇʀ ʙᴏᴛ", url="https://t.me/pakdiih"),
            ...
            button = [
                [InlineKeyboardButton("🔥 ʙᴜᴀᴛ ᴜsᴇʀʙᴏᴛ 🔥", callback_data="bahan")],
                [
                    InlineKeyboardButton("🛠 ᴜᴘᴅᴀᴛᴇs", callback_data="cb_gitpull"),
                    InlineKeyboardButton("ʀᴇsᴛᴀʀᴛ 🔄", callback_data="cb_restart"),
                ],
                [
                    InlineKeyboardButton("📋 ɢᴇᴛᴜʙᴏᴛ", callback_data="cek_ubot"),
                    InlineKeyboardButton("sᴛᴀᴛᴜs ᴠᴘs 💾", callback_data="host"),
                ],
            ]
        return button
    ...
    def plus_minus(query, user_id):
        button = [
            ...
            [
                ...
                InlineKeyboardButton("ᴋᴇᴍʙᴀʟɪ", callback_data="bahan"),
            ]
        ]
        return button
